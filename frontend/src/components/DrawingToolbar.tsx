        ...
        <Card className="p-4 shadow-lg border-border/50 bg-card/95 backdrop-blur-sm">
            <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1">
                    <Button
                        variant={
                            activeTool === "rectangle" ? "default" : "outline"
                        }
                        size="sm"
                    ...
                    <Button
                        variant={
                            activeTool === "circle" ? "default" : "outline"
                        }
                        size="sm"
                    ...
                    <Button
                        variant={
                            activeTool === "polygon" ? "default" : "outline"
                        }
                        size="sm"
                            ...
                            <div className="grid grid-cols-5 gap-2">
                                {colors.map((color) => (
                                    <button
                                        ...
                                        className={`w-8 h-8 rounded-md border-2 transition-all duration-200 hover:scale-110 ${color.class} ${
            ...
            {activeTool && (
                <div className="pt-3 border-t border-border">
                    ...
                    {activeTool === "polygon" && (
                        <p className="text-xs text-muted-foreground">
                            Effectue un clic droit pour terminer la forme
                        </p>
                    )}
                </div>
            )}
